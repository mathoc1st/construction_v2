...
<footer class="bg-dark-olive h-max w-screen">
	<div
	...
	>
		...
		<a href={resolve('/')} class="flex h-full items-center gap-2 max-[600px]:mt-10">
			<img src="/images/logo.jpg" alt="" class="w-14" />
			<span class="text-off-white text-lg font-semibold">СК РУС ДОМ</span>
		</a>
		<div>
			<ul class="text-off-white mt-8 text-center">
				<li>
					<a href={resolve('/')} class="hover:text-light-brown transition">Главная</a>
				</li>
				<li>
					<a href={resolve('/catalog')} class="hover:text-light-brown transition">Каталог</a>
				</li>
				<li>
					<a href={resolve('/')} class="hover:text-light-brown transition">Наши работы</a>
				</li>
				<li>
					<a href={resolve('/')} class="hover:text-light-brown transition">О нас</a>
				</li>
				<li>
					<a href={resolve('/')} class="hover:text-light-brown transition">Контакты</a>
				</li>
			</ul>
			<p class="text-off-white mt-6 mb-4 text-center text-sm max-[600px]:hidden">
